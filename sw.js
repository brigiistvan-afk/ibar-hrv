...
const CACHE_VERSION = '2026-03-21-r34';
...
self.addEventListener('fetch', event => {
  ...
  // A sw.js-t magát SOHA ne szolgáljuk gyorsítótárból. Ha ez a fájl
  // is a stale-while-revalidate logikába kerülne, a fejlesztő (vagy
  // bárki, aki ellenőrizni akarja a verziót) egy régi, gyorsítótárazott
  // választ láthat a valódi szerver-tartalom helyett – pontosan úgy,
  // mintha a feltöltés nem sikerült volna, miközben valójában sikerült.
